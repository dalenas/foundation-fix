...
>>>>>>> 9ae2eabe5e6d430ba55097c3c2d1ff9519d985e5
...
<<<<<<< HEAD
    ...
    The final iteration finalizes all brackets needed for the dispenser system, and includes a
    complete view of all the parts put together. We have included a L-bracket that connects the 
    dispenser to the casing, an L bracket that holds the guide rod, a syringe bracket to stabilize
    and hold the syringe in place, and finally, the plate that holds the plunger, and moves with
    the screw to push the plunger down. 
...
=======
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/first_it/CS_userflowfinal.png}
        \caption{User Flow Diagram}
    \end{figure}
    \pagebreak
    ...
    '\{"result":"<hex\_color>"\}' to the front end, which uses it for visualization for the user. 
    \bigbreak
...
>>>>>>> 9ae2eabe5e6d430ba55097c3c2d1ff9519d985e5
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{assets/final/lidcircuitry.png}
