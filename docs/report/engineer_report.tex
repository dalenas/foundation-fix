...
\begin{document}
    ...
    in the physical, non-digital world \cite[2]{LindbloomRGBXYZ}. The algorithm is primarily based 
    linear algebra transformations and matrix operations \cite[3]{LindbloomXYZLab}. 
    ...
    to LAB in '\texttt{xyz\_to\_lab()}' \cite[4]{MacAdamEllipsoids}.
    ...
    '\{"result":"<hex\_color>"\}' to the front end, which uses it for visualization for the user \cite[5]{OLearyUMD}. 
    \bigbreak
